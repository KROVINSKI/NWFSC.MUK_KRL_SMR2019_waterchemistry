...
# 13.0 Water Chemistry Around Treatment Means
...
```{r 13.2b Histrogram Scaled by Time Graphs plus Y liminator}
...
```{r 13.2c Histrogram Scaled by Time Graphs faceted wrapped}
...
```{r  13.3a Cumulative Frequency Distribution}
...
```{r 13.3b Cumulative Frequency Distribution, facet wrap, geomlines by DO percent}
...
```{r 13.3c Cumulative Frequency Distribution MOATs grouped by Treatment Colored by MOATs}
...
```{r 13.3d Actual DOmg ECDF Plot with Summary Table}
## 13.3d ECDF Plot
...
pHcoolECDF- will incorporate pH summary statistics. pH measurements discussed more in chapter 14.
...
#### 13.4b Aquarium Temperature with Empirical Cumulative Distribution "Cool" function (ECDF) 

```{r 13.4a Using the coolECDF function per treatment & period}
## 13.4a Using the coolECDF function per treatment & period
...
## 13.4b Incorporating Grid Arrange to display the ECDF plots        
# Basic Grid Arrange
...
```
#### 13.5 Actual Milligrams of Dissolved Oxygen with Empirical Cumulative Distribution "Cool" function (ECDF) 


```{r 13.5 Using the Actual Milligrams of Dissolved Oxygen with Empirical Cumulative Distribution "Cool" function (ECDF) }
...
## 13.5a Using the coolECDF function per treatment & period for DOmg
  ...
  DO.cfd.allchg.d <- DOcoolECDF(Cdml, H2Ochemdf.daynight.actualDO.summary, "allchange", "day",)
  DO.cfd.allchg.r <- DOcoolECDF(Cdml, H2Ochemdf.daynight.actualDO.summary, "allchange", "D2Nramp",)
  DO.cfd.allchg.n <- DOcoolECDF(Cdml, H2Ochemdf.daynight.actualDO.summary, "allchange", "night")
        
        
  DO.cfd.cur.d <- DOcoolECDF(Cdml, H2Ochemdf.daynight.actualDO.summary, "current", "day")
  DO.cfd.cur.r <- DOcoolECDF(Cdml, H2Ochemdf.daynight.actualDO.summary, "current", "D2Nramp")
  DO.cfd.cur.n <- DOcoolECDF(Cdml, H2Ochemdf.daynight.actualDO.summary, "current", "night")
        
        
  DO.cfd.hi.d <- DOcoolECDF(Cdml, H2Ochemdf.daynight.actualDO.summary, "hightemperature", "day")
  DO.cfd.hi.r <- DOcoolECDF(Cdml, H2Ochemdf.daynight.actualDO.summary, "hightemperature", "D2Nramp")
  DO.cfd.hi.n <- DOcoolECDF(Cdml, H2Ochemdf.daynight.actualDO.summary, "hightemperature", "night")
