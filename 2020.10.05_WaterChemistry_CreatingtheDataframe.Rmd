...
write.csv(H2Ochemdf.daynight.actualDO.summary, "2020.10.07_H2Ochemdf_daynight_actualDO_summary.csv")
...
write.csv(H2Ochemdf.daynight.pH.summary, "2020.10.08_H2Ochemdf_daynight_pH_summary.csv")
...
# 13.0 pH Water Chemistry Plots

```{r 12.3 Water Chemistry - pH Summary Table Plots}
...
ECDFplot13.3c <-  ggplot(H2Ochemdf, aes(actualDOmg)) +
                    stat_ecdf(aes(colour = moats)) + 
                    geom_vline(xintercept = H2Ochemdf.daynight.summary$mean, colour = "red") +
                    facet_wrap(vars(treatment, period), ncol = 2, scales = "fixed")  +
                    theme_bw()
ECDFplot13.3c
...
```{r 14.1 PH Day/Night Summary}
# 14.0) pH Day/Night Summary
#### 
...
write.csv(H2Ochemdf.daynight.pH.summary, "2020.10.07_H2Ochemdf_daynight_pH_summary.csv")
```
